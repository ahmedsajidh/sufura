...
@section('content')
    ...
    <form role="form" action="{{ route('create-slider') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="card-body">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input name="secondtitle" type="text" class="form-control thaana" id="exampleInputEmail1" placeholder="Post Title">
            </div>
        </div>
