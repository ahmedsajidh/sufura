...
@section('content')
    ...
    <section class="pt-5 mt-5 animate__animated animate__fadeIn">
        <div class="container" style="margin-top: 5px;">
            <h1 class=" thaana" style="font-size: 25px;">ހަބަރު</h1>
            <div class="row" style="direction: rtl;">
                <div class="col-md-12 mb-3 rtl">
                    <label for="cars">Choose a car:</label>

                    <select onChange="window.location.href=this.value" >
                        <option>select</option>
                        <option value="{{URL::current()."?sort=age7"}}">Age-7</option>
                        <option value="{{URL::current()."?sort=age9"}}">Age-8</option>
                    </select>
                    <span class="font-weight-bold">Sort By:</span>
                    <a href="{{URL::current()}}">All</a>
                    <a href="{{URL::current()."?sort=age"}}">OrderBY: ASC</a>
