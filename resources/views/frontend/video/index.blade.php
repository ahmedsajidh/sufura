                ...
                @foreach($habarus as $habaru)
                    <div class="col-md-3 col-lg-3 col-6 pb-2 card-deck" >
                        <div class="card" style="background-color: whitesmoke; " style="direction: rtl !important;">
                            <img class="card-img-right" src="/storage/video/{{$habaru->image}}">
                            <div class="card-body" style="direction: rtl !important;" >
                                ...
                                <a href="{{ URL::to('/post-video/') }}/{{$habaru->id}}" title=""> <h5 class="card-title thaana" style="direction: rtl !important; font-size: 19px; line-height: 2; ">{{$habaru->title}}</h5></a>
                            </div>
                        </div>
                    </div>
                @endforeach
