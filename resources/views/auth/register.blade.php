...
<div class="register-box">
    <div class="register-logo">
        <a href="."><b>Jamiyyath</b>Risaala</a>
    </div>
    ...
    <div class="register-box-body">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group has-feedback">
                <input type="text" class="form-control utheemfont rtl" placeholder="Name" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ old('name') }}" required autofocus>
